...
public class Order extends Model {
     ...
     * Между объектами классов Order и Status связь многие-к-одному, а именно
     ...
     * Между объектами классов Order и User связь один-к-одному, а именно каждая
     ...
     * Между объектами классов Order и User связь много-к-одному, а именно каждая
     * запись в одной таблице напрямую связана с отдельной записью в другой таблице.
     ...
     *
     * Значение типа String - строка описание заказа (номер, статус, дата, информация о клиенте,
